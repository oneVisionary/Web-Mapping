...
button1 = pn.widgets.Button(name="welcome", button_type="warning", icon="file-info", styles={"width": "100%"})
...
############################ CREATE PAGE LAYOUT ##################################
def WelcomePage():
    descr = "Welcome to the Youtube Statistic Analysis"
    return pn.Column(pn.pane.                                                                              (descr, width=550, style={'font-size': '30px','font-weight':'bold'}),
        align="center"
    )

def CreatePage2(df):
    return pn.Column(
        pn.pane.Markdown("## Youtube Statistical Dataset"),
        pn.pane.DataFrame(df, height=550, width=850),
        align="center",
    )
...
#################### SIDEBAR LAYOUT ##########################
sidebar = pn.Column(pn.pane.Markdown("## Menus"), button1, button2, button3, button4, button5, button6,
...
template = pn.template.BootstrapTemplate(
    title=" Youtube Statistical Analysis",
    sidebar=[sidebar],
    main=[main_area],
    header_background="black", 
    site="Web Mapping", logo="logo.png", theme=pn.template.DefaultTheme,
    sidebar_width=250, 
    busy_indicator=None,
)
